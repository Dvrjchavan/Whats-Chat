...
if uploaded_file is not None:
    try:
        ...
        if st.sidebar.button("Show Analysis"):
            ...
            df = helper.perform_sentiment_analysis(selected_user, df)
            ...
            st.write(f"<span style='font-size: 28px; color: white;'>{average_sentiment}</span>", unsafe_allow_html=True)
            ...
            # new
            influential_users = helper.identify_influential_users(df)
